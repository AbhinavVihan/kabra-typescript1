...
describe("should add product to cart", function () {
    it("should pass because product is already in cart", function (done) {
        (0, supertest_1.default)(app_1.default)
            ...
            image: "https://res.cloudinary.com/dzrmunwn7/image/upload/v1647893780/quuaecqiqsl32s4yh21s.jpg",
            price: 346,
            quantity: 1,
            productID: "6238dd14d8558d0d07f71da6",
        })
...
describe("should get cart", function () {
    it("should get logged in users's cart", (done) => {
        (0, supertest_1.default)(app_1.default)
            .get("/api/cart/myCart")
            .auth("Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYyM2I0ZWZlMWIxYWQ4NTBiMTk1NGU1ZSIsImlhdCI6MTY0ODA5ODIzOSwiZXhwIjoxNjU1ODc0MjM5fQ.f2AkMDbIvIuaea70GAi8JqVw7Jvq1jl-gLed4w0jc2E", { type: "bearer" })
            .end(function (err, res) {
...
describe("should create a new cart", function () {
    it("should pass because cart for this user already exists", (done) => {
        (0, supertest_1.default)(app_1.default)
            ...
            .then((r) => {
            console.log(r);
            (0, chai_1.expect)(r.status).to.equal(200);
        });
        done();
    });
});
